  ...
  return (
    <div>
      <div className="header">
        <div className="title leading-7xl">Settings</div>
      </div>
      ...
      <div className="text-sm leading-lg text-black">
        <span className="text-gray">English Company Name:</span>
        <span>{data?.name_en}</span>
      </div>
      <div className="text-sm leading-lg text-black mt-1">
        <span className="text-gray">Settlement Typ:</span>
